<template>
    <AuthenticatedLayout>
        <Head title="Settings / Burial Type" />
        ...
        <div class="py-1">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900 flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0 ">
                    <h3 class="text-2xl font-bold ">Settings - Burial Type</h3>
                ...
                <div class="px-6 pb-6 overflow-x-auto bg-white shadow-md rounded-lg mt-0">
                    <div v-if="is_created" id="alert-border-1" class="flex items-center p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50 " role="alert">
                        ...
                        <div class="ms-3 text-sm font-medium">
                            Burial Type Created Successfully.
                        </div>
                    ...
                    <div v-if="is_updated" id="alert-border-1" class="flex items-center p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50 " role="alert">
                        ...
                        <div class="ms-3 text-sm font-medium">
                            Burial Type Updated Successfully.
                        </div>
                    ...
                    <div v-if="is_deleted" id="alert-border-1" class="flex items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 " role="alert">
                        ...
                        <div class="ms-3 text-sm font-medium">
                            Burial Type Deleted Successfully.
                        </div>
                    ...
                    <table class="min-w-full border border-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Price</th>
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="border-b" v-for="(item, index) in filteredBurialTypes" :key="index">
                ...
                <div class="relative bg-white rounded-lg shadow-sm ">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                        <h3 class="text-xl font-semibold text-gray-900 ">
                            {{ form.is_editing ? 'Edit' : 'Create' }} Burial Type
                        </h3>
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <input v-model="form.price" type="number" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                        </div>
                    </div>
                    <!-- Modal footer -->
...
export default {
    ...
    created() {
        // console.log(usePage().props.errors); // Check the structure of the errors object
        // this.errors = usePage().props.errors || {};

        // this.errors = usePage().props.errors || {}; // Retrieve errors from Inertia props
    },
    mounted() {
    ...
    computed: {
        filteredBurialTypes() {
            if (!this.search) return this.burial_types;

            return this.burial_types.filter(t => {
    ...
    methods: {
        ...
        save() {
            this.form.post('/burial_type/store', {
                onSuccess: () => {
                    this.closeForm()
        ...
        update() {
            this.form.patch('/burial_type/update/'+this.form.id, {
                onSuccess: () => {
                    this.closeForm()
        ...
        deleteItem() {
            this.form.delete('/burial_type/destroy/'+this.delete_form.id, {
                onSuccess: () => {
