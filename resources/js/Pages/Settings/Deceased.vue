        ...
        <div class="py-1">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900 flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0 ">
                    <h3 class="text-2xl font-bold ">Settings - Deceased</h3>
                    ...
                    <table class="min-w-full border border-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Birth Date</th>
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Death Date</th>
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Cause of Death</th>
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Burial Date</th>
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="border-b" v-for="(item, index) in filteredDeceaseds" :key="index">
                                <td class="px-4 py-2">{{ index + 1 }}</td>
                                <td class="px-4 py-2">{{ item.full_name }}</td>
                                <td class="px-4 py-2">{{ item.birth_date }}</td>
                                <td class="px-4 py-2">{{ item.death_date }}</td>
                                <td class="px-4 py-2">{{ item.cause_of_death }}</td>
                                <td class="px-4 py-2">{{ item.burial_date }}</td>
                ...
                <div class="relative bg-white rounded-lg shadow-sm ">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                        <h3 class="text-xl font-semibold text-gray-900 ">
                            {{ form.is_editing ? 'Edit' : 'Create' }} Deceased
                        </h3>
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <div>
                            ...
                            <input v-model="form.full_name" type="text" placeholder="Last name, First name Middle name Ext" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Birth Date</label>
                            <input v-model="form.birth_date" type="date" placeholder="Last name, First name Middle name Ext" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Death Date</label>
                            <input v-model="form.death_date" type="date" placeholder="Last name, First name Middle name Ext" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Cause of Death</label>
                            <input v-model="form.cause_of_death" type="text" placeholder="" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">Burial Date</label>
                            <input v-model="form.burial_date" type="date" placeholder="Last name, First name Middle name Ext" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                        </div>
                    </div>
                    <!-- Modal footer -->
...
export default {
    ...
    computed: {
        filteredDeceaseds() {
            if (!this.search) return this.deceaseds;

            return this.deceaseds.filter(des => {
                return Object.values(des).some(value =>
    ...
    methods: {
        ...
        closeForm() {
            ...
            this.form.cause_of_death = ''
            this.form.burial_date = ''
        ...
        editItem(item) {
            ...
            this.form.death_date = item.death_date
            this.form.cause_of_death = item.cause_of_death
            this.form.burial_date = item.burial_date
            this.form.active = true
        ...
        update() {
            this.form.patch('/deceased/update/'+this.form.id, {
                onSuccess: () => {
                    this.closeForm()
        ...
        deleteItem() {
            this.form.delete('/deceased/destroy/'+this.delete_form.id, {
                onSuccess: () => {
